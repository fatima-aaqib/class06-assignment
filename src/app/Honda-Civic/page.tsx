    ...
    <div className="bg-blue-50 min-h-screen flex justify-center items-center p-6">
      <div className="bg-white rounded-lg shadow-lg p-8 max-w-2xl w-full text-center">
        ...
        <h1 className="text-3xl font-bold mb-4">
          <span className="font-black">Honda Civic 2024 Price in Pakistan, Images, Reviews & Specs</span>
        </h1>

        {/* Image */}
        <img
          
          src="https://di-honda-enrollment.s3.amazonaws.com/2021/model-pages/civic_hatchback/trims/Hatchback+Sport+Touring.jpg" 
        ...
        {/* Price */}
        <p className="text-3xl font-bold text-green-600">PKR 90,00,000</p>
